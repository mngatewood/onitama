		...
		<div id="data-mute-notifications" key="notifications-toggle" className="absolute top-4 left-4">
			<div className="relative group">
				<button onClick={handleToggle} className="border border-gray-400 rounded-full p-0 bg-gray-200 hover:scale-125 transition-all duration-300 group hover:bg-slate-400 hover:border-gray-200"
					...
					onMouseOut={(event) => event.currentTarget.title = "Toggle notifications"}
				>
				...
				<div className='absolute top-12 px-4 py-2 bg-slate-500 rounded-md text-purple border-gray-500 border left-0 text-lg opacity-0 group-hover:opacity-100 transition-all duration-200 transform scale-0 group-hover:scale-100'>
					<span className="h-0 w-0 absolute -top-2 left-2 border-x-8 border-x-transparent border-b-8 border-b-gray-500"></span>
