...
export const NewGameModal: React.FC<NewGameModalProps> = ({ handleNewSoloGame, handleNewMultiplayerGame, handleCancelNewGame }) => {

	return (
		<div className="absolute flex flex-col justify-center items-center mx-auto p-8 text-neutral-800 bg-gray-200 shadow-[0px_0px_100px_0px_rgba(0,0,0,0.7)] dark:shadow-[0px_0px_100px_0px_rgba(255,255,255,0.7)] rounded-2xl">
