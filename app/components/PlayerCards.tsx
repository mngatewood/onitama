...
export const PlayerCards = ({player}: {player: Player}) => {
	...
	return (
		<div className="player w-full h-full flex justify-between">
			<div className={`${playerColor} player-color w-6 h-10 border rounded-xl border-neutral-400 bg-neutral-400 flex justify-center items-center text-lg text-gray-300 ml-1 mr-3`}>
				{playerKanji}
			</div>
